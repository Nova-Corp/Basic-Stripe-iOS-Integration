...
class CheckoutViewController: UIViewController {
    ...
    var stripePublishableKey = "pk_test_GLbGo2fDNpLQIqoiFz3Q4UMF0042LSaKdk"
    ...
    var backendBaseURL: String? = "http://192.168.0.105/successcoachingadminpanel/public/api/stripe"
